task countdw_forkjoin_pclk4;
    ...
    $display("======================");
    $display("countdw_forkjoin_pclk4");
    $display("======================");    
    ...
    cpu.apb_write(ADDR_TCR, 8'b0011_0001, err); //load = 0, 1'b0, up/dw = 1 (down), enable = 1, 2'b00, cks = 01 (pclk*4)
