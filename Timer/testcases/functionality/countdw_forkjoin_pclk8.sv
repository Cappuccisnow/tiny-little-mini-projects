task countdw_forkjoin_pclk8;
    ...
    $display("======================");
    $display("countdw_forkjoin_pclk8");
    $display("======================");    
    ...
    cpu.apb_write(ADDR_TCR, 8'b0011_0010, err); //load = 0, 1'b0, up/dw = 1 (down), enable = 1, 2'b00, cks = 10 (pclk*8)
